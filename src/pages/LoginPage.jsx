...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#07111f]">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(16,185,129,0.20),transparent_30%),radial-gradient(circle_at_bottom_right,rgba(59,130,246,0.20),transparent_30%),linear-gradient(135deg,#07111f_0%,#0b172a_45%,#111827_100%)]" />
      ...
      >
        <div
          className={`min-w-65 rounded-2xl border px-5 py-4 text-white shadow-2xl backdrop-blur-xl ${
            toast.type === "error"
      ...
      <div className="relative z-10 grid min-h-screen lg:grid-cols-2">
        <div className="hidden lg:flex items-center justify-center p-10">
          <div className="relative h-[86%] w-full max-w-2xl overflow-hidden rounded-4xl border border-white/10 bg-white/5 shadow-[0_20px_80px_rgba(0,0,0,0.45)] backdrop-blur-sm">
            <img
            ...
            <div className="absolute inset-0 bg-linear-to-t from-[#07111f]/90 via-[#07111f]/35 to-transparent" />
        ...
        <div className="flex items-center justify-center px-5 py-10 sm:px-8">
          <div className="w-full max-w-130 rounded-4xl border border-white/10 bg-white/10 p-4 shadow-[0_20px_80px_rgba(0,0,0,0.35)] backdrop-blur-2xl sm:p-6">
            <div className="rounded-[28px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.18),rgba(255,255,255,0.08))] p-7 text-white sm:p-10">
              <div className="mb-8">
                <div className="mb-4 inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-linear-to-br from-emerald-400 to-cyan-400 text-xl font-black text-slate-900 shadow-lg">
                  NT
                </div>
